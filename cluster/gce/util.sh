...
STORAGE_FORCE_CPU_LIMIT: $(yaml-quote ${STORAGE_FORCE_CPU_LIMIT:-})
STORAGE_FORCE_MEM_LIMIT: $(yaml-quote ${STORAGE_FORCE_MEM_LIMIT:-})
IGNITE_STORAGE_SIZE: $(yaml-quote ${IGNITE_STORAGE_SIZE:-})
IGNITE_HAPROXY: $(yaml-quote ${IGNITE_HAPROXY:-})
